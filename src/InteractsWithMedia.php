...
use Cedvict\MediaLibrary\MediaCollections\Exceptions\InvalidBase64Data;
use Cedvict\MediaLibrary\MediaCollections\Exceptions\InvalidUrl;
use Cedvict\MediaLibrary\MediaCollections\Exceptions\MediaCannotBeDeleted;
use Cedvict\MediaLibrary\MediaCollections\Exceptions\MediaCannotBeUpdated;
use Cedvict\MediaLibrary\MediaCollections\Exceptions\MimeTypeNotAllowed;
...
{
    /** @var \Cedvict\MediaLibrary\Conversions\Conversion[] */
    public array $mediaConversions = [];

    /** @var \Cedvict\MediaLibrary\MediaCollections\MediaCollection[] */
    ...
    {
        return $this->morphMany(config('media-libraryc.media_model'), 'model');
    }
     ...
     * @return \Cedvict\MediaLibrary\MediaCollections\FileAdder
     *
     * @throws \Cedvict\MediaLibrary\MediaCollections\Exceptions\FileCannotBeAdded
     */
    public function addMediaFromUrl(string $url, ...$allowedMimeTypes): FileAdder
    {
        ...
        $downloader = config('media-libraryc.media_downloader', DefaultDownloader::class);
    ...
    {
        $tmpFile = tempnam(sys_get_temp_dir(), 'media-libraryc');
     ...
     *
     * @param int|\Cedvict\MediaLibrary\MediaCollections\Models\Media $mediaId
     *
     * @throws \Cedvict\MediaLibrary\MediaCollections\Exceptions\MediaCannotBeDeleted
     */
