...
use Cedvict\MediaLibrary\ResponsiveImages\Events\ResponsiveImagesGenerated;
use Cedvict\MediaLibrary\ResponsiveImages\Exceptions\InvalidTinyJpg;
...
class ResponsiveImageGenerator
{
    ...
    public function generateTinyJpg(
        ...
        $svg = view('media-libraryc::placeholderSvg', compact(
            'originalImageWidth',
            'originalImageHeight',
            'tinyImageBase64'
        ));
